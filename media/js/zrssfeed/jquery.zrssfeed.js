...
(function($){
	...
	var _process = function(e, data, options) {
		...
		if (!feeds) {
	        ...
	        if (options.process) {
		    options.process(e, data, options);
		    return;
		}

		var html = '';
		var row = 'theme-cell-background-color';
		...
		for (var i=0; i<feeds.entries.length; i++) {
			...
			if (row == 'theme-cell-background-color') {
				row = 'theme-cell-background-color2';
			} else {
				row = 'theme-cell-background-color';
			}
		}
