<?php include "header.php" ?>
	...
	<div style="margin-top:25px;padding-left:100px;"><img id="the-comment" src='' style="text-align:center;height:40px;visibility:hidden;"></div>
	<div style="padding-left:100px;"><img id="the-comment-fixed" src='img/cmt_click.png' style="text-align:center;height:30px;visibility:hidden;"></div>
